...
output_dir = os.path.join(main_output_dir, '{}_stratified_on_loge'.format(TARGET_DIRECTION))
...
for i in range(100):
    export_train_validation_test(i, fnames_numu[i], fnames_nue[i], out_dir=output_dir, target_key=TARGET_DIRECTION,
