...
model = TZ_updown_classification(num_classes=2)
model.summary()

N_FILES = 100
BATCH_SIZE = 64

DATA_FOLDER_NAME = 'updown_numu_nue_stratified'
TASK_NAME = 'updown_classification'
...
multi_data_folder = IRON_HIDE  # changed 26/01/2018
